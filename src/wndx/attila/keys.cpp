...
void Keys::scroll()
{
  ...
  case 0: sobj = ui.previewText; break;
  case 1: sobj = ui.spentText; break;
  default:
...
void Keys::scrollkeys()
{
  ...
  scrollkey(Qt::SHIFT | Qt::Key_J);
  scrollkey(Qt::SHIFT | Qt::Key_N);
  scrollkey(Qt::SHIFT | Qt::Key_K);
  scrollkey(Qt::SHIFT | Qt::Key_E);
  scrollkey(Qt::SHIFT | Qt::Key_L);
  scrollkey(Qt::SHIFT | Qt::Key_I);
  // scroll top/bot - g/G
  scrollkey(Qt::Key_G);
